...
public class RegisterActivity extends AppCompatActivity {
    ...
    public static final String EMAIL_KEY_R = "com.example.hp.socialnetwork.emailKeyR";
    public static final String USERNAME_KEY_R = "com.example.hp.socialnetwork.usernameKeyR";
                        ...
                        .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    addUsernameToUser(auth.getCurrentUser(),username);
                                    Intent intent = new Intent(RegisterActivity.this, MainActivity.class);
                                    intent.putExtra(EMAIL_KEY_R, email);
                                    intent.putExtra(USERNAME_KEY_R,username);
